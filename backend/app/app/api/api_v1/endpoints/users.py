...
#     Retrieve users.
#     """
#     users = domain_service.user.get_multi(db, skip=skip, limit=limit)
#     return users
#
#
...
#     Create new user.
#     """
#     user = domain_service.user.get_by_email(db, email=user_in.email)
#     if user:
#         raise HTTPException(
#             status_code=400,
...
#         user_in.email = email
#     user = domain_service.user.update(db, db_obj=current_user, obj_in=user_in)
#     return user
#
#
...
#     """
#     user = domain_service.user.get(db, id=user_id)
...
#         )
#     user = domain_service.user.update(db, db_obj=user, obj_in=user_in)
#     return user
